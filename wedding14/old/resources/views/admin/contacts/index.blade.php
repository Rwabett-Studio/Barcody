@include('admin.layouts.header')
    ...
    <div class="content pt-3">
        <div class="d-flex justify-content-between align-items-center border-bottom mainBordClr mb-lg-4 mb-0">
            <h4 class="fw-bold mb-0">List of Contacts</h4>
        ...
        <div class="col-12 position-relative pt-1">
            <div class="table-tools">
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ route('contacts.import.form') }}" class="btn mainBtn2 light-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="ms-3">
                                    <h6>{{ $contact->user_id }}</h6> <!-- Display user_id for debugging -->
                                </div>
                            </div>
                        </td>
