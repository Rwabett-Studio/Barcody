...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/invitations/{contact_id}/response',[ EventContactController::class ,'apishowInvitationResponse']);
    
    Route::post('/invitations/{contact_id}/response',[ EventContactController::class ,'apiprocessResponse']);
        
    Route::post('/invitations/thank-you',[ EventContactController::class ,'apishowThankYouPage']);
