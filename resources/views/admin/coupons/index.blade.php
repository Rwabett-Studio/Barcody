...
<div id="main" class="offset-lg-2">
    <div class="content pt-3">
        <div class="d-flex justify-content-between align-items-center border-bottom mainBordClr mb-lg-4 mb-0">
            ...
            <a href="{{ route('coupons.create') }}" class="d-flex align-items-center blueBtn">
        ...
        <div class="col-12 position-relative pt-1">
            <table id="couponsTable" class="w-100 mt-3">
                <thead>
                    <tr>
                        <th>Code</th>
                        <th>Type</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $coupon->plan?->title ?? 'All Plans' }}</td>
                        <td>
                            {{ $coupon->used_count }}
                        ...
                        <td>
                            ...
                            @else
                                <span class="redSpan">Inactive</span>
                            @endif
                        </td>
                        <td>
                            <div class="d-flex align-items-center actions gap-2">
