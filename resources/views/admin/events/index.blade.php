                    ...
                    <tr>
                        ...
                        <td>
                            <div class="compImgDv d-flex align-items-center">
                                <div class="ms-3">
                                    <a href="{{ route('event.detail', ['id' => $event->id]) }}">{{ $event->name }}</h6>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="compImgDv d-flex align-items-center">
                                <div class="ms-3">
                                    <h6> {{ $event->user ? $event->user->name : 'Unknown User' }}</h6> <!-- Display creator name -->
                                </div>
                            </div>
                        </td>
                        ...
                        <!--  <img src="https://linkatt.com/staging/WeddingAppDashboard/storage/app/public/{{ $event->thumbnail_image }}" alt="Thumbnail" style="max-width: 100px;">-->
                        ...
                        <td>
                            <span class="{{ $event->status == 'published' ? 'greenSpan' : 'redSpan' }} border">
                                <i class="fa-solid {{ $event->status == 'published' ? 'fa-check' : 'fa-xmark' }} me-2"></i>
                                {{ $event->status }}
                            </span>
                        </td>

                        <td>
                            {{ $event->category->name }} <!-- Display Category Name -->
                        </td>
