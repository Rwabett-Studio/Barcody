                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="position-relative">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{ $heroSection->name }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="position-relative">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control" value="{{ $heroSection->title }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="position-relative">
                                    ...
                                    @if ($heroSection->main_image)
                                        <img src="https://linkatt.com/staging/WeddingAppDashboard/storage/app/public/{{  $heroSection->main_image }}" alt="Main Image" style="max-width: 50px;">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="position-relative">
                                    ...
                                    @if ($heroSection->image1)
                                        <img src="https://linkatt.com/staging/WeddingAppDashboard/storage/app/public/{{$heroSection->image1 }}" alt="Image 1" style="max-width: 50px;">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="position-relative">
                                    ...
                                    @if ($heroSection->image2)
                                        <img src="https://linkatt.com/staging/WeddingAppDashboard/storage/app/public/{{  $heroSection->image2 }}" alt="Image 2" style="max-width: 50px;">
                                    @endif
                                </div>
                            </div>
