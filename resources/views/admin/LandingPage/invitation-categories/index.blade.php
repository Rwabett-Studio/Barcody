...
<div id="main" class="offset-lg-2">
    ...
    <div class="content pt-3">
        ...
        <div class="col-12 position-relative pt-1">
            <table id="invitationCategoriesTable" class="w-100 mt-3">
                <thead>
                    <tr>
                        <th>
                ...
                <tbody>
                    ...
                    <tr>
                       <td>
                        ...
                        <td>
                            @if ($category->image)
                                <img src="https://linkatt.com/staging/WeddingAppDashboard/storage/app/public/{{ $category->image }}" alt="Category Image" style="max-width: 50px;">
                            @else
                                No Image
                            @endif
                        </td>
                        <td>
                            <div class="d-flex align-items-center actions">
                                ...
                                <a href="{{ route('invitation-categories.edit', $category->id) }}">
