...
<div id="main" class="offset-lg-2">
    ...
    <div class="content pt-3">
        <div class="d-flex justify-content-between align-items-center border-bottom mainBordClr mb-lg-4 mb-0">
            <h4 class="fw-bold mb-0">How To Use Barcody</h4>
            <a href="{{ route('how-use-barcodies.create') }}" class="d-flex align-items-center blueBtn">
                <i class="fas fa-plus"></i> <span>Add How To Use</span>
            </a>
        </div>
        <div class="col-12 position-relative pt-1">
            <table id="howUseTable" class="w-100 mt-3">
                <thead>
                    <tr>
                        <th>
                ...
                <tbody>
                    ...
                    <tr>
                     ...
                     <td>
                        ...
                        <td>{{ Str::limit($howUse->description, 50) }}</td>
                        <td>
                            @if ($howUse->image)
                                <img src="https://linkatt.com/staging/WeddingAppDashboard/storage/app/public/{{ $howUse->image }}" alt="How To Use Image" style="max-width: 50px;">
                            @else
                                No Image
                            @endif
                        </td>
                        <td>
                            <div class="d-flex align-items-center actions">
                                ...
                                <a href="{{ route('how-use-barcodies.edit', $howUse->id) }}">
