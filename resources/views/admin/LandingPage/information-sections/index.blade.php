...
<div id="main" class="offset-lg-2">
    ...
    <div class="content pt-3">
        <div class="d-flex justify-content-between align-items-center border-bottom mainBordClr mb-lg-4 mb-0">
            <h4 class="fw-bold mb-0">Information Section</h4>
            <a href="{{ route('information-sections.create') }}" class="d-flex align-items-center blueBtn">
                <i class="fas fa-plus"></i> <span>Add Information</span>
            </a>
        </div>
        <div class="col-12 position-relative pt-1">
            <table id="informationTable" class="w-100 mt-3">
                <thead>
                    <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center actions">
                                ...
                                <a href="{{ route('information-sections.edit', $info->id) }}">
