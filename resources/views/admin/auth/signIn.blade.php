    ...
    <div class="logFormDV center mb-lg-5 mb-2">
        ...
        <div class="col-lg-9 center pt-lg-5 pt-2">
          <div class="text-center ">
            ...
            <h6 class="fs-16 mt-3 fw-700">Sign in with WunderUI</h6>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="position-relative">
                  <input type="text" placeholder="hello@wunderui.com" name="email">
                  <span>
              ...
              {{-- <div class="col-12 remember">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <span class="lh-1">
                    ...
                    <span class="ps-4"> Keep me logged in </span>
                  </span>
                  <a href="forgetPass.html" class="mt-2">forget password?</a>
                </div>
              </div> --}}
              <div class="col-12">
                ...
                <h6 class="mt-3">Don't have an account? <a href="{{ route('register') }}">Sign up here.</a></h6>
