@include('admin.layouts.header')
    ...
    <div class="content pt-3">
        <div class="d-flex justify-content-between align-items-center border-bottom mainBordClr mb-lg-4 mb-0">
            <h4 class="fw-bold mb-0">Setting</h4>
            {{-- <a href="{{ route('settings.create') }}" class="d-flex align-items-center blueBtn">
                <i class="fas fa-plus"></i> <span>Add Setting</span>
            </a> --}}
        </div>
            ...
            <table id="contactTable" class=" w-100 mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($setting->fav_icon)
                                <img src="https://linkatt.com/staging/WeddingAppDashboard/storage/app/public/{{ $setting->fav_icon }}" alt="Fav Icon" style="max-width: 50px;">
                        ...
                        <td>
                            ...
                            <img src="https://linkatt.com/staging/WeddingAppDashboard/storage/app/public/{{ $setting->header_logo }}" alt="Header Logo" style="max-width: 50px;">
                        @else
                            No Logo
                        @endif
                        </td>
                        ...
                        <td>
                            ...
                            <img src="https://linkatt.com/staging/WeddingAppDashboard/storage/app/public/{{ $setting->footer_logo }}" alt="Footer Logo" style="max-width: 50px;">
                            @else
                                No Logo
                            @endif
                        </td>
