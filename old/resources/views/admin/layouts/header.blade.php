          ...
          <ul class="list-unstyled ps-0">
              ...
              <li class="mb-1">
                  <a href="{{url('contacts')}}" class="btn d-inline-flex align-items-center">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M9 21.9999H15C20 21.9999 22 19.9999 22 14.9999V8.99988C22 3.99988 20 1.99988 15 1.99988H9C4 1.99988 2 3.99988 2 8.99988V14.9999C2 19.9999 4 21.9999 9 21.9999Z" stroke="#809FB8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                          <path d="M8.46997 10.6404L12 14.1604L15.53 10.6404" stroke="#809FB8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                          </svg>
          ...
          <div class="dropdown profileDrobdown ">
            <button class="btn d-flex align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
              <div class="position-relative me-2">
                <img src="img/user.png" alt=""><span></span>
